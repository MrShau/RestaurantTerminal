...
{
    /// <inheritdoc />
    public partial class RT_1_0_1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    CountOrdered = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActivityStatistics", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ActivityStatistics_Employees_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityStatistics_EmployeeId",
                table: "ActivityStatistics",
                column: "EmployeeId");
